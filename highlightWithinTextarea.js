...
(function ($) {
    ...
    HighlightWithinTextarea.prototype = {
        ...
        generate: function () {
            ...
            // console.log('this.$el2',this.$backdrop);
        ...
        renderMarks: function (boundaries) {
            ...
            input = input.replace(/\{\{hwt-mark-start\|(\d+)\}\}/g, function (match, submatch) {
                ...
                if (className) {
                    return '<mark style="background-color: transparent !important" class="mark-border-ext" ' + className + '">';
                } else {
                    return '<mark>';
                }
            });
                ...
                if (plugin) {
                    switch (options) {
                        ...
                        case 'destroy':
                            ...
                            break;
                        default:
                            console.log('unrecognized method string');
                    }
                } else {
                    console.log('plugin must be instantiated first');
                }
            } else {
                if (plugin) {
                    // $($this).before('.hwt-backdrop').remove();
                    plugin.destroy();
                }
